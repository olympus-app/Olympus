...
public class BlockSpacingAnalyzer : DiagnosticAnalyzer {
	...
	private static readonly LocalizableString Title = new LocalizableResourceString(nameof(Strings.BlockSpacingTitle), Strings.Values.ResourceManager, typeof(Strings));

	private static readonly LocalizableString MessageAfterOpen = new LocalizableResourceString(nameof(Strings.BlockSpacingMessageAfterOpen), Strings.Values.ResourceManager, typeof(Strings));

	private static readonly LocalizableString MessageBeforeClose = new LocalizableResourceString(nameof(Strings.BlockSpacingMessageBeforeClose), Strings.Values.ResourceManager, typeof(Strings));

	private static readonly LocalizableString Description = new LocalizableResourceString(nameof(Strings.BlockSpacingDescription), Strings.Values.ResourceManager, typeof(Strings));
