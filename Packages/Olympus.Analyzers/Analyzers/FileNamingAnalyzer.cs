...
public class FileNamingAnalyzer : DiagnosticAnalyzer {
	...
	private static readonly LocalizableString Title = new LocalizableResourceString(nameof(Strings.FileNamingTitle), Strings.Values.ResourceManager, typeof(Strings));

	private static readonly LocalizableString Message = new LocalizableResourceString(nameof(Strings.FileNamingMessage), Strings.Values.ResourceManager, typeof(Strings));

	private static readonly LocalizableString Description = new LocalizableResourceString(nameof(Strings.FileNamingDescription), Strings.Values.ResourceManager, typeof(Strings));
