...
public class ReturnStatementSpacingAnalyzer : DiagnosticAnalyzer {
	...
	private static readonly LocalizableString Title = new LocalizableResourceString(nameof(Strings.ReturnSpacingTitle), Strings.Values.ResourceManager, typeof(Strings));

	private static readonly LocalizableString Message = new LocalizableResourceString(nameof(Strings.ReturnSpacingMessage), Strings.Values.ResourceManager, typeof(Strings));

	private static readonly LocalizableString Description = new LocalizableResourceString(nameof(Strings.ReturnSpacingDescription), Strings.Values.ResourceManager, typeof(Strings));
