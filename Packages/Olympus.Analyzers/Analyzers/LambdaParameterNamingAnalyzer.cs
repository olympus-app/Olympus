...
public class LambdaParameterNamingAnalyzer : DiagnosticAnalyzer {
	...
	public const string Identifier = "OL0005";

	public const string Category = "Semantics";

	public const string PropertyName = "SuggestedName";

	private static readonly LocalizableString Title = new LocalizableResourceString(nameof(Strings.LambdaParameterNamingTitle), Strings.Values.ResourceManager, typeof(Strings));

	private static readonly LocalizableString Message = new LocalizableResourceString(nameof(Strings.LambdaParameterNamingMessage), Strings.Values.ResourceManager, typeof(Strings));

	private static readonly LocalizableString Description = new LocalizableResourceString(nameof(Strings.LambdaParameterNamingDescription), Strings.Values.ResourceManager, typeof(Strings));
