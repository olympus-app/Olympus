...
public class SuffixNamingAnalyzer : DiagnosticAnalyzer {
	...
	private static readonly LocalizableString Title = new LocalizableResourceString(nameof(Strings.SuffixNamingTitle), Strings.Values.ResourceManager, typeof(Strings));

	private static readonly LocalizableString Message = new LocalizableResourceString(nameof(Strings.SuffixNamingMessage), Strings.Values.ResourceManager, typeof(Strings));

	private static readonly LocalizableString Description = new LocalizableResourceString(nameof(Strings.SuffixNamingDescription), Strings.Values.ResourceManager, typeof(Strings));
