...
public class InitializerSpacingAnalyzer : DiagnosticAnalyzer {
	...
	private static readonly LocalizableString Title = new LocalizableResourceString(nameof(Strings.InitializerSpacingTitle), Strings.Values.ResourceManager, typeof(Strings));

	private static readonly LocalizableString MessageRemoveAfterOpen = new LocalizableResourceString(nameof(Strings.InitializerSpacingMessageRemoveAfterOpen), Strings.Values.ResourceManager, typeof(Strings));

	private static readonly LocalizableString MessageRemoveBeforeClose = new LocalizableResourceString(nameof(Strings.InitializerSpacingMessageRemoveBeforeClose), Strings.Values.ResourceManager, typeof(Strings));

	private static readonly LocalizableString MessageRemoveBetweenItems = new LocalizableResourceString(nameof(Strings.InitializerSpacingMessageRemoveBetweenItems), Strings.Values.ResourceManager, typeof(Strings)); // NOVO

	private static readonly LocalizableString Description = new LocalizableResourceString(nameof(Strings.InitializerSpacingDescription), Strings.Values.ResourceManager, typeof(Strings));
