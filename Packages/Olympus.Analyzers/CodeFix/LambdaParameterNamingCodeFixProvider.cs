...
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(LambdaParameterNamingCodeFixProvider))]
public class LambdaParameterNamingCodeFixProvider : CodeFixProvider {

	public override ImmutableArray<string> FixableDiagnosticIds => [LambdaParameterNamingAnalyzer.Identifier];
	...
	public override Task RegisterCodeFixesAsync(CodeFixContext context) {
		...
		if (!diagnostic.Properties.TryGetValue(LambdaParameterNamingAnalyzer.PropertyName, out var suggestedName)) return Task.CompletedTask;

		var title = string.Format(Strings.Values.LambdaParameterNamingCodeFixTitle, suggestedName);
