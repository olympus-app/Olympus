...
public class FileNamingCodeFixProvider : CodeFixProvider {
	...
	private static readonly LocalizableString TitleFormat = new LocalizableResourceString(nameof(Strings.FileNamingCodeFixTitle), Strings.Values.ResourceManager, typeof(Strings));
