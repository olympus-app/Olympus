...
public static partial class ModulesRegistrator {
	...
	private static partial void AddModulesBase(this WebAssemblyHostBuilder builder, AppModulesInfo info);
	...
	private static partial void AddModulesLayers(this WebAssemblyHostBuilder builder, AppModulesInfo info);
	...
	private static partial void AddModulesOptions(this WebAssemblyHostBuilder builder, AppModulesInfo info);
	...
	private static partial void AddModulesRoutes(this WebAssemblyHostBuilder builder, AppModulesInfo info);
	...
	private static partial void AddModulesPermissions(this WebAssemblyHostBuilder builder, AppModulesInfo info);

	private static void AddModule<TModule>(this WebAssemblyHostBuilder builder, AppModulesInfo info) where TModule : class, IAppModule, new() {
	...
	private static void AddModuleLayers<TLayer>(this WebAssemblyHostBuilder builder, AppModulesInfo info) where TLayer : class, IAppModuleLayer, new() {
	...
	private static void AddModuleOptions<TOption>(this WebAssemblyHostBuilder builder, AppModulesInfo info) where TOption : class, IAppModuleOptions, new() {
	...
	private static void AddModuleRoutes<TRoutes>(this WebAssemblyHostBuilder builder, AppModulesInfo info) where TRoutes : class, IAppModuleRoutes, new() {
	...
	private static void AddModulePermissions<TPermissions>(this WebAssemblyHostBuilder builder, AppModulesInfo info) where TPermissions : class, IAppModulePermissions, new() {
	...
	public static void AddModules(this WebAssemblyHostBuilder builder, AppModulesInfo info) {
